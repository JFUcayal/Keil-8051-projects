...
STATE_RECOVER:
	...
	CLR C
	SUBB A,N_SELECTED
	JNZ STATE_RECOVER			;ENQUANTO NAO CHEGAR AO FIM DA TRANSIÇAO DAS CHAVES FICA EM LOOP PARA INSERIR CADA POSICAO
...
;------------------------------------
SR_ADD_10:
	MOV DPTR,#TIME_ARRAY		;cada posiçao aumenta 10s
	MOV A,TIME_INDEX
	MOVC A,@A+DPTR
	MOV	R6,A
